...
#  Description: Recursion practice problems part 1, we stop after the countHi question
...
def countHi(str):
  if len(str) < 2:
    ...
    if (str[0] + str[1] == "hi"):
      return countHi(str[1:]) + 1
    else:
      return countHi(str[1:]) + 0
